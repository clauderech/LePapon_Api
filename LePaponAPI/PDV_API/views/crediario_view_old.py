...
def crediario_view(page: ft.Page):
    ...
    def exportar_pdf():
        try:
            ...
            if not crediarios_periodo.empty:
                ...
                c.drawString(40, height-40, f"Relatório de Crediário: {cliente_nome}")
    ...
    def enviar_conta_cliente(e):
        ...
        try:
            ...
            numero_cliente = '5554991253180' #next((c.get('telefone', '') for c in clientes if str(c.get('id', '')) == str(cliente_id)), None)
